...
Public Class Form1
    Dim time As Integer
    Dim conString As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\Database1.accdb"
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Sheet3TableAdapter.Fill(Me.Database1DataSet.Sheet3)
        LoadComboBox()
    ...
    Private Sub LoadComboBoxReference()
        ...
        con.Open()
        Dim query As String = "select distinct REFERENCE from sheet3 order by REFERENCE"
    ...
    Private Sub LoadComboBoxBankName()
        Dim con As New OleDbConnection(conString)
        con.Open()
        Dim query As String = "select distinct BANK_NAME from sheet3 order by BANK_NAME"
        Dim cmd As New OleDbCommand(query, con)
        Dim reader As OleDbDataReader
        reader = cmd.ExecuteReader()
        While reader.Read
    ...
    Private Sub LoadComboBoxApplicant()
        Dim con As New OleDbConnection(conString)
        con.Open()
        Dim query As String = "select distinct APPLICANT from sheet3 order by APPLICANT"
        Dim cmd As New OleDbCommand(query, con)
        Dim reader As OleDbDataReader
        reader = cmd.ExecuteReader()
        While reader.Read
    ...
    Private Sub LoadComboBoxCategory()
        Dim con As New OleDbConnection(conString)
        con.Open()
        Dim query As String = "select distinct CATEGORY from sheet3 order by CATEGORY"
        Dim cmd As New OleDbCommand(query, con)
        Dim reader As OleDbDataReader
        reader = cmd.ExecuteReader()
        While reader.Read
    ...
    Private Sub Button10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button10.Click
        If MsgBox("EXIT?", MsgBoxStyle.Question Or MsgBoxStyle.ApplicationModal Or MsgBoxStyle.OkCancel) = MsgBoxResult.Ok Then
            Me.Close()
        End If
    End Sub
    ...
    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            'Me.Sheet3TableAdapter.FillBy(Me.Database1DataSet.Sheet3, TextBox7.Text)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Sheet3BindingSource.MoveNext()
    End Sub

    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Sheet3BindingSource.MoveLast()
    End Sub

    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Sheet3BindingSource.MoveFirst()
    End Sub

    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Sheet3BindingSource.MovePrevious()
    End Sub
    ...
    Private Sub Books_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Books.SelectionChanged
        ...
        Else
            ...
            '    Dim path = Application.StartupPath() + pdf
            '    AxAcroPDF1.LoadFile(path)
            'Else
            '    Dim path = Application.StartupPath() + "\PDF\NO_PDF.pdf"
            '    AxAcroPDF1.LoadFile(path)
            'End If
    ...
    Private Sub Button8_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        Dim con As New OleDbConnection(conString)
        con.Open()
        Dim query As String = "select BANK_NAME,FORMAT(OPINION, 'DD-MM-YYYY') AS OPINION,REFERENCE,APPLICANT,CATEGORY,PROPERTY,PDF from sheet3 where BANK_NAME LIKE @BANK_NAME and REFERENCE LIKE @REFERENCE and APPLICANT LIKE @APPLICANT and CATEGORY LIKE @CATEGORY and PROPERTY LIKE @PROPERTY order by BANK_NAME"
        Dim cmd As New OleDbCommand(query, con)
        ...
        dt.Load(reader)
        Sheet3BindingSource.DataSource = dt
        con.Close()
    End Sub
    ...
    Private Sub Button11_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button11.Click
        ...
        Dim con As New OleDbConnection(conString)
        con.Open()
        Dim query As String = "select BANK_NAME,FORMAT(OPINION, 'DD-MM-YYYY') AS OPINION,REFERENCE,APPLICANT,CATEGORY,PROPERTY,PDF from sheet3 where OPINION between @fromDate and @toDate"
        Dim cmd As New OleDbCommand(query, con)
