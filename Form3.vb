...
Public Class Form3
                ...
                If fileSystemInfo.Extension.ToLower = ".txt" Then
                    ...
                    Using sr As New StreamReader(filePath)
                        ...
                        Try
                            ...
                            con.Open()
                            Dim query As String = "insert into Sheet3(BANK_NAME,OPINION,REFERENCE,APPLICANT,CATEGORY,PROPERTY,PDF) values(@BANK_NAME,FORMAT(@OPINION,'DD-MM-YYYY'),@REFERENCE,@APPLICANT,@CATEGORY,@PROPERTY,@PDF)"
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        Dim destDir As String = Application.StartupPath() + "\PDFs\NORMAL OPINION\"
